...
insert into workout.workouts (date, total_time, workout_type, user_id) values (now(), 600, 'testtype', 2);
insert into workout.workouts (date, total_time, workout_type, user_id) values (now(), 1200, 'testtype', 2);
insert into workout.workouts (date, total_time, workout_type, user_id) values (now(), 700, 'testtype', 2);
insert into workout.workouts (date, total_time, workout_type, user_id) values (now(), 7000, 'testtype', 2);

insert into workout.run (date, distance, mile_avg, speed_avg, workout_id) values (now(), 6, 8, 4, 1);
insert into workout.run (date, distance, mile_avg, speed_avg, workout_id) values (now(), 6, 8, 4, 4);

insert into workout.exercise (time, workout_id) values (600, 2);
insert into workout.exercise (time, workout_id) values (600, 3);

insert into workout.sets (weight, reps, exercise_id, lift_id) values (125, 12, 1, 3);
insert into workout.sets (weight, reps, exercise_id, lift_id) values (125, 12, 1, 3);
insert into workout.sets (weight, reps, exercise_id, lift_id) values (125, 12, 1, 3);
insert into workout.sets (weight, reps, exercise_id, lift_id) values (125, 12, 1, 3);

insert into workout.sets (weight, reps, exercise_id, lift_id) values (45, 12, 2, 4);
insert into workout.sets (weight, reps, exercise_id, lift_id) values (45, 12, 2, 4);
insert into workout.sets (weight, reps, exercise_id, lift_id) values (55, 12, 2, 4);
